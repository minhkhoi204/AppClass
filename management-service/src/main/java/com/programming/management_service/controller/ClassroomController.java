...
public class ClassroomController {
    ...
    @GetMapping("/{classroomId}/details")
    public ResponseEntity<ApiResponse> getClassroomDetails(@PathVariable Long classroomId) {
        ClassroomDto dto = classroomService.getClassroomWithDetails(classroomId);
        return ResponseEntity.ok(new ApiResponse("Classroom details", dto));
    }
